...
@section('form_field')
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('keluarga_posyandu') is-invalid @enderror" name="keluarga_posyandu">
            ...
            <option value="ya" @selected(old('keluarga_posyandu') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('keluarga_posyandu') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('bayi_gizi_baik') is-invalid @enderror" name="bayi_gizi_baik">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('bayi_gizi_baik') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('bayi_gizi_baik') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('lansia_posyandu') is-invalid @enderror" name="lansia_posyandu">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('lansia_posyandu') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('lansia_posyandu') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('keluarga_jaskesmas') is-invalid @enderror" name="keluarga_jaskesmas">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('keluarga_jaskesmas') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('keluarga_jaskesmas') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('pus_kb') is-invalid @enderror" name="pus_kb">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('pus_kb') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('pus_kb') == 'tidak')>Tidak</option>
        </select>
        @error('pus_kb')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('pus_tidak_kb') is-invalid @enderror" name="pus_tidak_kb">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('pus_tidak_kb') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('pus_tidak_kb') == 'tidak')>Tidak</option>
        </select>
        @error('pus_tidak_kb')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('keluarga_bkb') is-invalid @enderror" name="keluarga_bkb">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('keluarga_bkb') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('keluarga_bkb') == 'tidak')>Tidak</option>
        </select>
        @error('keluarga_bkb')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('keluarga_bkr') is-invalid @enderror" name="keluarga_bkr">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('keluarga_bkr') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('keluarga_bkr') == 'tidak')>Tidak</option>
        </select>
        @error('keluarga_bkr')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('keluarga_bkl') is-invalid @enderror" name="keluarga_bkl">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('keluarga_bkl') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('keluarga_bkl') == 'tidak')>Tidak</option>
        </select>
        @error('keluarga_bkl')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('keluarga_uppks') is-invalid @enderror" name="keluarga_uppks">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('keluarga_uppks') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('keluarga_uppks') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('peserta_paguyuban') is-invalid @enderror" name="peserta_paguyuban">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('peserta_paguyuban') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('peserta_paguyuban') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('remaja_pikr') is-invalid @enderror" name="remaja_pikr">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('remaja_pikr') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('remaja_pikr') == 'tidak')>Tidak</option>
        </select>
        @error('remaja_pikr')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('remaja_saka_kencana') is-invalid @enderror" name="remaja_saka_kencana">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('remaja_saka_kencana') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('remaja_saka_kencana') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('blt') is-invalid @enderror" name="blt">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('blt') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('blt') == 'tidak')>Tidak</option>
        </select>
        @error('blt')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('pkh') is-invalid @enderror" name="pkh">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('pkh') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('pkh') == 'tidak')>Tidak</option>
        </select>
        @error('pkh')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('bst') is-invalid @enderror" name="bst">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('bst') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('bst') == 'tidak')>Tidak</option>
        </select>
        @error('bst')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('banpres') is-invalid @enderror" name="banpres">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('banpres') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('banpres') == 'tidak')>Tidak</option>
        </select>
        @error('banpres')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('bantuan_umkm') is-invalid @enderror" name="bantuan_umkm">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('bantuan_umkm') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('bantuan_umkm') == 'tidak')>Tidak</option>
        </select>
        @error('bantuan_umkm')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('bantuan_pekerja') is-invalid @enderror" name="bantuan_pekerja">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('bantuan_pekerja') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('bantuan_pekerja') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('bantuan_pendidikan') is-invalid @enderror" name="bantuan_pendidikan">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('bantuan_pendidikan') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('bantuan_pendidikan') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('bantuan_listrik') is-invalid @enderror" name="bantuan_listrik">
            <option value="" selected>Pilih Status</option>
            <option value="ya" @selected(old('bantuan_listrik') == 'ya')>Ya</option>
            <option value="tidak" @selected(old('bantuan_listrik') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('manfaat_pekarangan') is-invalid @enderror" name="manfaat_pekarangan">
            <option value="" selected>Pilih Status</option>
            <option value="ada" @selected(old('manfaat_pekarangan') == 'ada')>Ada</option>
            <option value="tidak" @selected(old('manfaat_pekarangan') == 'tidak')>Tidak</option>
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('keluarga_tani') is-invalid @enderror" name="keluarga_tani">
            <option value="" selected>Pilih Status</option>
            <option value="ada" @selected(old('keluarga_tani') == 'ada')>Ada</option>
            <option value="tidak" @selected(old('keluarga_tani') == 'tidak')>Tidak</option>
        </select>
        @error('keluarga_tani')
            <div class="invalid-feedback">
                {{ $message }}
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('keluarga_rukun_nelayan') is-invalid @enderror" name="keluarga_rukun_nelayan">
            <option value="" selected>Pilih Status</option>
            <option value="ada" @selected(old('keluarga_rukun_nelayan') == 'ada')>Ada</option>
            <option value="tidak" @selected(old('keluarga_rukun_nelayan') == 'tidak')>Tidak</option>
        </select>
