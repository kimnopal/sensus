...
@section('form_field')
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('kondisi_pekerjaan') is-invalid @enderror" name="kondisi_pekerjaan">
            ...
            @foreach ($dataKondisiPekerjaan as $kondisiPekerjaan)
                <option value="{{ $kondisiPekerjaan->id }}" @selected(old('kondisi_pekerjaan', $data->kondisi_pekerjaan_id) == $kondisiPekerjaan->id)>{{ $kondisiPekerjaan->nama }}
                </option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('pekerjaan_utama') is-invalid @enderror" name="pekerjaan_utama"
            ...
            @foreach ($dataPekerjaanUtama as $pekerjaanUtama)
                <option value="{{ $pekerjaanUtama->id }}" @selected(old('pekerjaan_utama', $data->pekerjaan_utama_id) == $pekerjaanUtama->id)>{{ $pekerjaanUtama->nama }}
                </option>
            @endforeach
        </select>
    ...
    <div class="form-group">
        ...
        <select class="form-control @error('status_jamsostek') is-invalid @enderror" name="status_jamsostek">
            ...
            <option value="peserta" @selected(old('status_jamsostek', $data->status_jamsostek) == 'peserta')>Peserta</option>
            <option value="bukan peserta" @selected(old('status_jamsostek', $data->status_jamsostek) == 'bukan peserta')>Bukan Peserta</option>
        </select>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control @error('no_jamsostek') is-invalid @enderror" name="no_jamsostek"
            value="{{ old('no_jamsostek', $data->no_jamsostek) }}">
        @error('no_jamsostek')
            <div class="invalid-feedback">
                {{ $message }}
            </div>
                        ...
                        @forelse ($data->list_penghasilan as $penghasilan)
                            @if ($penghasilan->sumber_penghasilan_id == $sumberPenghasilan->id)
                                <input type="text"
                                    ...
                                    value="{{ old('sumber_penghasilan.' . $sumberPenghasilan->id . '.penghasilan', $penghasilan->penghasilan) }}">
                            @break
                    ...
                    @forelse ($data->list_penghasilan as $penghasilan)
                        @if ($penghasilan->sumber_penghasilan_id == $sumberPenghasilan->id)
                            <select
                                ...
                                <option value="semua" @selected(old('sumber_penghasilan.' . $sumberPenghasilan->id . '.ekspor', $penghasilan->ekspor) == 'semua')>Semua</option>

                                <option value="sebagian besar" @selected(old('sumber_penghasilan.' . $sumberPenghasilan->id . '.ekspor', $penghasilan->ekspor) == 'sebagian besar')>Sebagian Besar</option>

                                <option value="tidak" @selected(old('sumber_penghasilan.' . $sumberPenghasilan->id . '.ekspor', $penghasilan->ekspor) == 'tidak')>Tidak</option>
                            </select>
                        @break
